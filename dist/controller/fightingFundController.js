...
const fightingFundController = {
    ...
    DepositsTransaction: (req, res, next) => {
        ...
        if (user == phone_no) {
            ...
            fightingFundModel.find({ $and: [{ accountNo: accountNo }, { password: req.body.password }] }, async function (err, result) {
                if (err) {
                    res.json({
                        isError: true,
                        data: err
                            ...
                            if (newAmt > 0) {
                                ...
                                fightingFundModel.findOneAndUpdate({ accountNo: accountNo }, { $set: { isTransaction: true } }, options, function (err, data) {
                                    if (err) {
                                        ...
                                        query = { 'accountNo': accountNo }, update = {
    ...
    WithdrawalTransaction: (req, res, next) => {
        ...
        if (user == phone_no) {
            ...
            fightingFundModel.find({ $and: [{ accountNo: accountNo }, { password: req.body.password }]
...
//# sourceMappingURL=fightingFundController.js.map
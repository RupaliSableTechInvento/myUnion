...
const routes = route => {
  ...
  route.route('/getElection').post(electionController.getElection);
  route.route('/updateElection').post(electionController.updateElection);
  ...
  route.route('/approveCandidateData').post(electionController.approveCandidateData);
